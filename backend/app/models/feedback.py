...
class CitizenFeedback(Base):
    ...
    # Default is "approved" — Nagarik's editorial commitment is to immediate publication.
    # The "pending" / "rejected" values exist only for moderator-driven removal after the fact.
