...
class Document(Base):
    ...
    # Citizen-flagged factual disputes. When a user reports an error, this is
    # set to True and the explanation goes in dispute_note. The document remains
    # visible — Nagarik's commitment is to transparency, including over its own
    # mistakes — but the UI surfaces a "marked for review" banner.
