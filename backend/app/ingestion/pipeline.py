    ...
    try:
        ...
        for source in sources:
            ...
            try:
                ...
                # Clear failed transaction state before touching ORM attributes again.
                db.rollback()
                logger.exception("Source %s totally failed", source_slug)
                results.append({"source": source_slug, "status": "failed", "error": str(e)})
